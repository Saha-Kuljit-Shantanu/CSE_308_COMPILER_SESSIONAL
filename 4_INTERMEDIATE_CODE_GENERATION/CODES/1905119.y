...
func_declaration : type_specifier ID LPAREN parameter_list RPAREN SEMICOLON{
			...
			$$ = new SymbolInfo($4);
			$$ -> setSymbolName("func_declaration");
...
compound_statement : LCURL statements RCURL{
			...
			$$ -> setSymbolName("compound_statement");
...
declaration_list : declaration_list COMMA ID {
			...
			$$ = new SymbolInfo($1);
			$$ -> setSymbolName("declaration_list");
...
embed_left : {
	...
	$$ = new SymbolInfo("embed_left");
	$$ -> setSymbolName("embed_left");
	table.EnterScope();
...
expression_statement 	: SEMICOLON {
			...
			$$ -> setSymbolName("expression_statement");
...
logic_expression : rel_expression {
			...
			$$ = new SymbolInfo($1);
			$$ -> setSymbolName("logic_expression");
...
simple_expression : term {
			...
			$$ = new SymbolInfo($1);
			$$ -> setSymbolName("simple_expression");
...
unary_expression : ADDOP unary_expression {
			...
			$$ = new SymbolInfo($2);
			$$ -> setSymbolName("unary_expression");
